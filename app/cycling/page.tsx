...
<div className=" bg-black min-h-screen ">
    ...
    <div className="flex flex-row items-center sm:flex lg:flex w-full">
      <img alt="interview" src="/cycling/pics.svg" className=" h-80 w-80 ml-10 mt-10"/>
      <div>
      ...
      <img alt="interview" src="/cycling/location.svg" className="h-5 w-5 ml-10 mt-5"/>
      <h4 className="font-bold text-white ml-16 -mt-5 mb-3">UGM</h4>
      <img alt="interview" src="/cycling/time.svg" className="h-5 w-5 ml-10"/>
    ...
    <div className="flex flex-row-reverse items-center">
      <img alt="interview" src="/cycling/pics2.svg" className="h-80 w-80 mr-10  mt-10"/>
      <div>
      <h1 className=" text-2xl text-white font-bold ml-40 mb-3 ">Upcoming Tour de Frances</h1>
      <h3 className=" text-white ml-40 mr-40 text-justify sm:w-1/2 xl:w-1/4  ">Lorem ipsum dolor sit amet consectetur adipisicing elit.
      Sed earum, voluptate aliquid reiciendis minima nihil incidunt.
      Corporis beatae eos suscipit labore voluptatem nostrum eligendi natus
      quod dolor? Voluptatem, soluta corporis.</h3>
      <img alt="interview" src="/cycling/location.svg" className="h-5 w-5 ml-40 mt-5"/>
      <h4 className="font-bold text-white ml-48 -mt-5 mb-3">UGM</h4>
      <img alt="interview" src="/cycling/time.svg" className="h-5 w-5 ml-40"/>
    ...
    <div className="flex flex-row items-center">
      <img alt="interview" src="/cycling/pics3.svg" className=" h-80 w-80 ml-10 mt-10 "/>
      <div>
      <h1 className="text-2xl text-white font-bold ml-10 mt-5 mb-3 ">Upcoming Tour de Frances</h1>
      <h3 className=" text-white ml-10 mr-40 text-justify sm:w-1/2 xl:w-1/4 ">Lorem ipsum dolor sit amet consectetur adipisicing elit.
      Sed earum, voluptate aliquid reiciendis minima nihil incidunt.
      Corporis beatae eos suscipit labore voluptatem nostrum eligendi natus
      quod dolor? Voluptatem, soluta corporis.</h3>
      <img alt="interview" src="/cycling/location.svg" className="h-5 w-5 ml-10 mt-5"/>
