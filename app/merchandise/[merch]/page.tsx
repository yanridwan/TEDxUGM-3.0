    ...
    return (
        <main className="relative">
            ...
            <section className="bgMerch flex items-center justify-center h-screen ">
                <div className="flex flex-col md:flex-row gap-5 md:gap-20 mx-10 rounded-lg  relative z-30 sm:mx-20 aspect-square md:items-center justify-center">
                    <img src={`/${searchParams.image}`} alt={productName} className="w-[30vw] rounded-3xl border-solid border-4 aspect-square" placeholder="blur" />
